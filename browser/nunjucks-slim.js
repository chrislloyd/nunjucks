...
/***/ function(module, exports) {
	...
	function installCompat() {
	  ...
	  // this adds support for uppercase True and False
	  ...
	  var ARRAY_MEMBERS = {
	    ...
	    extend: function(arr) {
	      // Can't use concat because we want to have the side-effect of adding elements to the current array.
	  ...
	  var OBJECT_MEMBERS = {
	    /*
	    "items" is disabled intentionally.
	    Jinja treats "." and "[]" operators differently and Python has a distinction between
	    attributes and items.  Nunjucks and JavaScript have no such distinction, and intercepting
	    the member lookup of "items" is making it impssible to access any Object property named
	    "items", which is a name we'd like to be able to use.
	    */
	    iteritems: function() {
	      var ret = [];
	      for(var k in this) {
	    ...
	    get: function(key, def) {
	      var output = this[key];
	      // In Python, the default value for .get() is "None". which JSON serializes to "null".
	      // Make this match Python by returning "null" if "key" doesn't exist.
	      if (output === undefined) {
	        if (def === undefined) {
	          output = null;
	        } else {
	  ...
	  runtime.memberLookup = function(obj, val) {
	    obj = obj || {};
